...
final class UnsuspendCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'env:unsuspend
     ...
     * @var string
     */
    protected $description = 'Unsuspend an environment';
    ...
    public function handle(): int
    {
        ...
        try {
            $environment = $client->unsuspendEnvironment($siteId, $environmentId);

            if ($this->shouldOutputJson()) {
                $this->outputJson($environment);
            } else {
                $this->outputSuccess('Environment unsuspended successfully.');
            }
