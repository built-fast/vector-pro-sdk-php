...
final class StatusCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'ssl:status
     ...
     * @var string
     */
    protected $description = 'Show SSL certificate status for an environment';
    ...
    public function handle(): int
    {
        ...
        try {
            $status = $client->getSslStatus($siteId, $envId);

            $this->outputResource($status, [
                'status' => 'Status',
                'domain' => 'Domain',
                'issuer' => 'Issuer',
